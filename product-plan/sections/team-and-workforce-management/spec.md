...
- Manager views workforce planning with projected gaps and hiring/training recommendations
- Manager explores scenario modeling to analyze what-if decisions
- Manager reviews competency gaps via gap lists and heatmap/matrix visualizations
...
- Gap list or alerts highlighting missing certifications
- Team detail view with summary metrics at top and member list below
- Workforce planning interface with projected gaps, hiring recommendations, training priorities, and scenario modeling tools
- Team comparison visualizations for cross-team analysis
