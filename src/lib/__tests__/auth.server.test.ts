...
import { getAuthenticatedUser, getVerifiedAuth, requireRole } from '../auth.server'
...
describe('auth.server.ts', () => {
    ...
    describe('getVerifiedAuth', () => {
        ...
        it('should throw error when userId is null', async () => {
            ...
            await expect(getVerifiedAuth()).rejects.toThrow('Unauthorized: No user session')
        })
    ...
    describe('getAuthenticatedUser', () => {
        ...
        it('should throw error when user not found in database', async () => {
            ...
            await expect(getAuthenticatedUser()).rejects.toThrow('Unauthorized: User not found')
        })
        ...
        it('should throw error when database is not available', async () => {
            ...
            await expect(getAuthenticatedUser()).rejects.toThrow('Database not available')
        })
    ...
    describe('requireRole', () => {
        ...
        it('should reject User role when not in allowed list', async () => {
            ...
            await expect(requireRole(['Admin', 'Manager'])).rejects.toThrow('Forbidden')
        })
