...
export function UserManagement() {
  ...
  if (isLoading)
    return <div className="p-4 text-slate-500">Loading user records...</div>
                    ...
                    <div className="flex gap-2 justify-end">
                      ...
                      <button
                        onClick={() => {
                          if (
                            confirm(
                              `Are you sure you want to delete ${user.name}? This will remove all their certification data from the platform.`,
                            )
                          ) {
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[60] p-4">
          <div className="bg-white dark:bg-slate-900 rounded-xl p-6 w-full max-w-md shadow-2xl border border-slate-200 dark:border-slate-700 animate-in fade-in zoom-in duration-200">
            ...
            <div className="flex gap-3 mt-8">
              ...
              <button
                onClick={() =>
                  updateMutation.mutate({ id: editingUser.id, ...editForm })
                }
